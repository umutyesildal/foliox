...
Basalt is the composition layer: bundle xStocks (Backed tokenized equities, native Token-2022) into strategy baskets with immutable weights and capped fees — 90% of fees go to the basket creator.
